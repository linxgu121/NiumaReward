...
namespace NiumaReward.Bridge
{
    /// <summary>
    /// 奖励 UI Toolkit 接收器。
    /// 挂在 UIRoot/UIBridges 下，并拖给 RewardUIViewBridge 的 Reward UI Receiver Provider。
    /// </summary>
    public sealed class RewardToolkitReceiver : MonoBehaviour, IRewardUIReceiver
    {
        ...
        [Tooltip("收到 Cleared 更新时是否关闭奖励窗口。")]
        ...
        public void ApplyRewardUpdate(RewardUIUpdate update)
        {
            ...
            if (update.UpdateType == RewardUIUpdateType.Cleared)
            {
